...
# Das hier setzt es ein bisschen bunt
PS1='\[\e[0;31m\]\u@\h\[\e[m\] \[\e[1;34m\]\w\[\e[m\] \[\e[1;31m\]\$\[\e[m\] \[\e[0;37m\]'
if [ "$USER" = "root" ]; then
        PS1='\h:\w # '
      fi
#=====================================================================================
...
nb-forward() { ssh -N -L localhost:"$@":localhost:"$@" vorwerk@sol28.physik.hu-berlin.de; }
# define command to connect to sol28 via sshfs
